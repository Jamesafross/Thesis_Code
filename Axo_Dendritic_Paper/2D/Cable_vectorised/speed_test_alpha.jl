...
const D = (0.03)^2 #diffusion coefficient cable equation
const k = 0.0#d #milliseconds #x10^-3 seconds
...
invalfa_vec = LinRange(0.1,4,40)
alfa_vec = 1 ./invalfa_vec
...
c_numeric_vector_k[i] = trackSpeed(g_sol[:,d,:],Int(60/dr),Int(66/dr),dt,dr,h,size(g_sol,3),0.1)
print("c = ",c_numeric_vector_k[i],"\n")
end

npzwrite("/tmp/c_numeric_alfa-0.1_2.npy",c_numeric_vector_k)
